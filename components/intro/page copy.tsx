        ...
        <div className='flex flex-col items-start gap-6'>
          <div className='text-gray-800 text-2xl font-light flex flex-col items-start gap-4'>
              ...
              <span className='inline-flex relative group/apps gap-2 sm:gap-0'>
                ...
                >
                  ...
                  <span className='absolute -top-8 left-1/2 -translate-x-1/2 bg-black text-white px-2.5 py-1 rounded-xl bg-opacity-80 text-xs opacity-0 sm:group-hover/ellie:opacity-100 transition-opacity whitespace-nowrap hidden sm:block'>
                    Nigeria Creators - Connect Nigeria creators with brands
                  </span>
                </a>
                {/* <a
                  ...
                  target='_blank'
                  rel='noopener noreferrer'
                  className='relative group/luna'
                >
                  <img
                    src='/apps/medvive.png'
                    alt='Medvive'
                    className='w-10 h-10 sm:transform sm:rotate-3 sm:group-hover:rotate-0 sm:group-hover:translate-x-2 transition-all duration-200 relative z-20 rounded-xl cursor-pointer border border-gray-200 shadow-sm'
                  />
                  <span className='absolute -top-8 -translate-x-16 bg-black text-white px-2.5 py-1 rounded-xl bg-opacity-80 text-xs opacity-0 sm:group-hover/luna:opacity-100 transition-opacity whitespace-nowrap hidden sm:block'>
                    Medvive - An online healthcare providers
                  </span>
                </a>
                <a
                  href='https://mogulnetworking.com'
                  target='_blank'
                  rel='noopener noreferrer'
                  className='relative group/mogul'
                >
                  <img
                    src='https://storage.googleapis.com/creatorspace-public/sites%2Ftouchicons%2FaHR0cHM6Ly9jZG4ucHJvZC53ZWJzaXRlLWZpbGVzLmNvbS81ZWZhZTA3MzJkOWMxZDFiNDhiYzgzMjQvNWYzZDgwZTQzZDNhZmJlNzE4ZDRlOTA3X2JpZ19maWNvbl9ibGFjay5wbmc%3D.png'
                    alt='Mogul'
                    className='w-10 h-10 sm:transform sm:-rotate-6 sm:group-hover:rotate-0 sm:group-hover:translate-x-4 sm:-translate-x-4 transition-all duration-200 relative z-30 rounded-xl cursor-pointer border border-gray-200 shadow-sm'
                  />
                  <span className='absolute -top-8 -translate-x-16 bg-black text-white px-2.5 py-1 rounded-xl bg-opacity-80 text-xs opacity-0 sm:group-hover/mogul:opacity-100 transition-opacity whitespace-nowrap hidden sm:block'>
                    Mogul - A better networking app
                  </span>
                </a>
                <a
                  href='https://amyfoodjournal.com'
                  target='_blank'
                  rel='noopener noreferrer'
                  className='relative group/amy'
                >
                  <img
                    src='/assets/amy_logo-Bq4EKNcA.png'
                    alt='Amy'
                    className='w-10 h-10 sm:transform sm:rotate-6 sm:group-hover:rotate-0 sm:group-hover:translate-x-6 sm:-translate-x-8 transition-all duration-200 relative z-40 rounded-xl cursor-pointer border border-gray-200 shadow-sm'
                  />
                  <span className='absolute -top-8 -translate-x-8 bg-black text-white px-2.5 py-1 rounded-xl bg-opacity-80 text-xs opacity-0 sm:group-hover/amy:opacity-100 transition-opacity whitespace-nowrap hidden sm:block'>
                    Amy - Food Journal
                  </span>
                </a> */}
              </span>
            ...
            <span className='inline-flex relative group items-start flex-col sm:flex-row sm:items-center gap-2'>
              ...
              <a
                href='https://youtube.com/@raroque'
                target='_blank'
                rel='noopener noreferrer'
            ...
            <span className='inline-flex relative group items-start flex-col sm:flex-row sm:items-center gap-2 mt-8'>
              <span>
                ...
                <br /> where we help companies build AI tools.
              </span>
            </span>
